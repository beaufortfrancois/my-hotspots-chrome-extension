...
## How to add a new captive portal in 3 steps
...
3. Add the captive portal URL to the `optional_permissions` key in [src/manifest.json](https://github.com/beaufortfrancois/my-hotspots-chrome-extension/blob/master/src/manifest.json)
